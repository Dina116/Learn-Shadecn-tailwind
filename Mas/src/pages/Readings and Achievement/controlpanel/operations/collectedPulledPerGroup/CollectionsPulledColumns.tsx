...
export type WalkDataWithStatus = WalkData & {
  status?: StatusType;
  isFetchingStatus?: boolean;
};
export const getCollectionsPulledColumns = (
  allData: WalkDataWithStatus[],
  selectedRowKeys: string[],
  onSelectionChange: (keys: string[]) => void,
  onUpdateRow: (bookNo: string) => void,
  onShowError: (bookNo: string) => void,
  selectableRows: WalkDataWithStatus[],
