...
import useReadingsPosting from "./useReadingsPosting";
import type { BOOKCYCLE } from "../../types";
import { TableErrorsColumns } from "../columns";
import { useEffect } from "react";
import PostedFlages from "./PostedFlages";

export default function ReadingsPosting() {
  const {
    columns,
    counters,
    ...
    <div className="w-full h-screen flex bg-gray-100">
      <div className="flex-1 ps-2 pe-2">
        ...
        <div className="flex flex-col gap-5">
          <MasPageHeader title="ترحيل القراءات" />
          <Form
      ...
      <PostedFlages
        open={flagesDialogOpen}
        handleClose={() => setFlagesDialogOpen(false)}
        handleSubmitFlages={handleSubmitFlages}
      />
    </div>
  );
}
